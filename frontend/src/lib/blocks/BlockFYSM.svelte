<script>
    ...
    const list = [
        ...
        "FYSM - це про дисципліну, чесніть та результат. Алгоритми (послідовність вправ) покривають усі ключові запити і потреби сучасної людини яка хоче отримати від йоги “усе і одразу“",
